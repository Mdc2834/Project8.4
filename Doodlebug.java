...
{
	final static int starvationThreshold = 3;
	int timeSinceEat;
	...
	public void moveBug(int direction)
	{
		...
		switch (direction) {
			case 1: World.field[this.getRowPosition() - 1][this.getColPosition()] = null; //Remove Ant
				World.field[this.getRowPosition() - 1][this.getColPosition()] = this; //Copy over DB
				World.field[this.getRowPosition()][this.getColPosition()] = null; //Remove old DB
				this.setRowPosition(this.getRowPosition() - 1);
				break;

			case 2: World.field[this.getRowPosition()][this.getColPosition() + 1] = null; //Remove Ant
				World.field[this.getRowPosition()][this.getColPosition() + 1] = this; //Copy over DB
				World.field[this.getRowPosition()][this.getColPosition()] = null; //Remove old DB
				this.setColPosition(this.getColPosition() + 1);
				break;

			case 3: World.field[this.getRowPosition() + 1][this.getColPosition()] = null; //Remove Ant
				World.field[this.getRowPosition() + 1][this.getColPosition()] = this; //Copy over DB
				World.field[this.getRowPosition()][this.getColPosition()] = null; //Remove old DB
				this.setRowPosition(this.getRowPosition() + 1);
				break;

			case 4: World.field[this.getRowPosition()][this.getColPosition() - 1] = null; //Remove Ant
				World.field[this.getRowPosition()][this.getColPosition() - 1] = this; //Copy over DB
				World.field[this.getRowPosition()][this.getColPosition()] = null; //Remove old DB
				this.setColPosition(this.getColPosition() - 1);
				break;
